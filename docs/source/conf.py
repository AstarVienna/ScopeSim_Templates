...
htmlhelp_basename = 'ScopeSimTemplatesdoc'
...
man_pages = [
    (master_doc, 'ScopeSim Templates', 'ScopeSim Templates Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ScopeSim Templates', 'ScopeSim Templates Documentation',
     author, 'ScopeSim Templates', 'One line description of project.',
     'Miscellaneous'),
]
